...
class DRMModel(ChainList):
    """DRMModel; the neural network which includes populations, connections and readouts
    """

    def __init__(self, populations, ws, Wp, readout, gpu=-1):
        """ DRMModel initializer
...
class DRM(object):
    ...
    def __init__(self, drm_model):
        """

        :param drm_net: a DRM model
        """

        self.model = drm_model
